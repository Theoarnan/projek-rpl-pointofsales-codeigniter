...
<head>
	...
	<title>POS APP| Ubah Password</title>
...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<a href="#"><b>POS</b>Application</a>
		</div>
		<!-- /.login-logo -->
		<div class="card">
			<div class="card-body login-card-body">
				<p class="login-box-msg"><?php $this->view('message') ?></p>
				...
				<form id="form-first-login" action="<?= site_url("login/saveNewPassword") ?>" method="post">
					...
					<div class="form-group">
						<div class="input-group mb-3">
							<input type="password" required name="confirm_password" id="confirm-password" class="form-control" placeholder="Confirm Password">
							<div class="input-group-prepend reveal">
								<button type="button" class="btn btn-danger">
									<i class="fas fa-eye-slash"></i>
								</button>
					...
					<div class="row">
						<div class="col-12">
							<button id="btn-save" type="button" class="btn btn-primary btn-block btn-flat">Simpan Password</button>
						</div>
						<!-- /.col -->
					</div>
				</form>
